        ...
        return (
            <div className="thewholefuckingbackground">
              <div className="thefuckingotherdiv">
                ...
                <Link className= "verylongvariablethatyouwontbeabletounderstandasingletimebecauselongvariableequalsicannotgetfired linkcolor" to="/"><h5 className="linkcolor">Click this link!</h5></Link>
              </div>
            </div>
        )
    }
